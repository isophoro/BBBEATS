...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'pan-slammin':
				dialogue = CoolUtil.coolTextFile(Paths.txt('pan-slammin/panDialogue'));
		}
		...
		else if (SONG.song.toLowerCase() == 'pan-slammin' || SONG.song.toLowerCase() == 'pi')
		{
			defaultCamZoom = 0.9;
			curStage = 'adobe';
			var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('da bg'));
	...
	function endSong():Void
	{
		...
		if (isStoryMode)
		{
			...
			if (storyPlaylist.length <= 0)
			{
				...
				if (curSong.toLowerCase() == 'pan-slammin' && FlxG.save.data.secretEnding == null)
				{
					  FlxG.save.data.secretEnding = true;
				}

			if(curSong.toLowerCase() == 'pan-slammin')
