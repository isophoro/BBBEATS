...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-w-carol':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('da_GF_ass_sets');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'bbpanzu':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('bbpanzu_assets_hahaaaa_lessgooo');
				frames = tex;
				animation.addByPrefix('idle', 'da idle', 24);
				animation.addByPrefix('singUP', 'da up', 24);
				animation.addByPrefix('singRIGHT', 'da right', 24);
				animation.addByPrefix('singDOWN', 'da down', 24);
				animation.addByPrefix('singLEFT', 'da left', 24);
